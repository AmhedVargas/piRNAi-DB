...
mkdir piRNADB_c_briggsae
cd piRNADB_c_briggsae
...
../QueryInGenomeWithMMinWindow2.pl c_briggsae.PRJNA10731.WS274.genomic.fa CDS-20mers.fasta 20 0 1 20 20.tab
...
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Unique-20mers-noT.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Unique-20mers-noT.fasta > Cbri_gen_0MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_0MM_piRNA-seqs.sam | awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_0MM_piRNA-seqs.bed
...
../QueryInGenomeWithMMinWindow.pl c_briggsae.PRJNA10731.WS274.genomic.fa Unique-18mers-noT.fasta 20 1 2 19 | awk -F"\t" '{if($3==1){print $1"\n"$2}}' > Unique18mers-1MM-noT.fasta

##Obtain positions of uniquely mapped by bwa
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Unique18mers-1MM-noT.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Unique18mers-1MM-noT.fasta > Cbri_gen_1MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_1MM_piRNA-seqs.sam | awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_1MM_piRNA-seqs.bed
...
makeblastdb -in c_briggsae.PRJNA10731.WS274.genomic.fa -dbtype 'nucl' -title c_briggsae.WS274

##Blast filtered unique 18 mer sequences using "blast short algorithm"
blastn -db c_briggsae.PRJNA10731.WS274.genomic.fa -query Unique18mers-1MM-noT.fasta -task "blastn-short" -out Blast18mers-1MM.tab -outfmt 6 -evalue 1 -num_threads 20
...
awk '{if($0 ~ />/){name=$0;}else{print name"\t"$0}}' Unique18mers-1MM-noT.fasta | awk -F">" '{print $2}' | awk -F"\t" '{if(array[$1] != 0){print ">"$1"\n"array[$1]}else{array[$1]=$2}}' - Blast_18mers_filt-2MM.txt > Cbri_gen_2MM_piRNA-seqs.fasta

##Map unique to obtain position
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Cbri_gen_2MM_piRNA-seqs.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Cbri_gen_2MM_piRNA-seqs.fasta > Cbri_gen_2MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_2MM_piRNA-seqs.sam| awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_2MM_piRNA-seqs.bed
...
##Parse output to create a file with the indexes of the unique sequences
awk '{if($0 ~ />/){name=$0;}else{print name"\t"$0}}' Unique18mers-1MM-noT.fasta | awk -F">" '{print $2}' | awk -F"\t" '{if(array[$1] != 0){print ">"$1"\n"array[$1]}else{array[$1]=$2}}' - Blast_18mers_filt-3MM.txt > Cbri_gen_3MM_piRNA-seqs.fasta

##Map unique to obtain position
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Cbri_gen_3MM_piRNA-seqs.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Cbri_gen_3MM_piRNA-seqs.fasta > Cbri_gen_3MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_3MM_piRNA-seqs.sam | awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_3MM_piRNA-seqs.bed

###4 mismatches by 16-mer and blast strategy
## Use previous unique mer fasta and convert it into 16 mer (2MM-16-2MM)
#4 MM
awk '{if($0 ~ />/){name=$0;}else{for(i=1; i<=(length($0)-19); i++){print name"_"i"separatortoto"substr($0,i,20)"\n"substr($0,i+2,16)}}}' Cbri_gen_3MM_piRNA-seqs.fasta > 3MM-CDS-16mers.fasta

##Look for uniqueness in 18 mers with perl script (hash method)
../QueryInGenomeWithMMinWindow2.pl c_briggsae.PRJNA10731.WS274.genomic.fa 3MM-CDS-16mers.fasta 16 0 1 16 16.tab
...
blastn -db c_briggsae.PRJNA10731.WS274.genomic.fa -query Unique-16mers-noT-3MM.fasta -task "blastn-short" -out Blast16mers-3MM.tab -outfmt 6 -evalue 1 -num_threads 20
...
##Parse output to create a file with the indexes of the unique sequences
awk '{if($0 ~ />/){name=$0;}else{print name"\t"$0}}' Unique-16mers-noT-3MM.fasta | awk -F">" '{print $2}' | awk -F"\t" '{if(array[$1] != 0){print ">"$1"\n"array[$1]}else{array[$1]=$2}}' - Blast_16mers_filt-4MM.txt > Cbri_gen_4MM_piRNA-seqs.fasta

##Map unique to obtain position
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Cbri_gen_4MM_piRNA-seqs.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Cbri_gen_4MM_piRNA-seqs.fasta > Cbri_gen_4MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_4MM_piRNA-seqs.sam| awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_4MM_piRNA-seqs.bed
...
#5 MM
awk '{if($0 ~ />/){name=$0;}else{for(i=1; i<=(length($0)-19); i++){print name"_"i"separatortoto"substr($0,i,20)"\n"substr($0,i+5,15)}}}' Cbri_gen_4MM_piRNA-seqs.fasta > 4MM-CDS-R15mers.fasta

##Look for uniqueness in 15 mers with perl script (hash method)
../QueryInGenomeWithMMinWindow2.pl c_briggsae.PRJNA10731.WS274.genomic.fa 4MM-CDS-R15mers.fasta 15 0 1 15 15.tab

##Convert into fasta files sequences that appear only once, place it as 20mer; Ts have been removed before.
awk -F"\t" '{if($3 == 1){print $1}}' 15.tab | awk -F"separatortoto" '{print $1"\n"$2}' - > Unique-R15mers-noT-4MM.fasta

##Blast filtered unique 16 mer sequences using "blast short algorithm"
blastn -db c_briggsae.PRJNA10731.WS274.genomic.fa -query Unique-R15mers-noT-4MM.fasta -task "blastn-short" -out Blast15mers-4MM.tab -outfmt 6 -evalue 1 -num_threads 20
...
##Parse output to create a file with the indexes of the unique sequences
awk '{if($0 ~ />/){name=$0;}else{print name"\t"$0}}' Unique-R15mers-noT-4MM.fasta | awk -F">" '{print $2}' | awk -F"\t" '{if(array[$1] != 0){print ">"$1"\n"array[$1]}else{array[$1]=$2}}' - Blast_16mers_filt-5MM.txt > Cbri_gen_5MM_piRNA-seqs.fasta

#Align sequences back to the genome and convert map to a bed file
bwa aln -n 0 -o 0 c_briggsae.PRJNA10731.WS274.genomic.fa Cbri_gen_5MM_piRNA-seqs.fasta | bwa samse c_briggsae.PRJNA10731.WS274.genomic.fa - Cbri_gen_5MM_piRNA-seqs.fasta > Cbri_gen_5MM_piRNA-seqs.sam
grep "XT:A:U" Cbri_gen_5MM_piRNA-seqs.sam | awk -F"\t" '{OFS="\t";if($2==16){str="-"}else{str="+"}print $3,($4-1),($4+19),$1,$6,str}' | sort -k1,1 -k2,2n > Cbri_gen_5MM_piRNA-seqs.bed
